...
const CUIDATA: &[(i32, &[Ref])] = &[
    ...
    (8, &[(0, 0, 3, 0, 0), (1, 2, 3, 0, 0), (2, 4, 3, 0, 0), (3, 6, 3, 0, 0)]),
    (10, &[(1, 2, 3, 0, 0), (2, 4, 3, 0, 0), (3, 6, 3, 0, 0), (4, 8, 3, 0, 0)]),
    (12, &[(2, 4, 3, 0, 0), (3, 6, 3, 0, 0), (4, 8, 3, 0, 0), (5, 10, 3, 0, 0)]),
    (14, &[(3, 6, 3, 0, 0), (4, 8, 3, 0, 0), (5, 10, 3, 0, 0), (6, 12, 3, 0, 0)]),
    (16, &[(4, 8, 3, 0, 0), (5, 10, 3, 0, 0), (6, 12, 3, 0, 0), (7, 14, 3, 0, 0)]),
    (18, &[(5, 10, 3, 0, 0), (6, 12, 3, 0, 0), (7, 14, 3, 0, 0), (8, 16, 3, 0, 0)]),
    (20, &[(6, 12, 3, 0, 0), (7, 14, 3, 0, 0), (8, 16, 3, 0, 0), (9, 18, 3, 0, 0)]),
    (22, &[(7, 14, 3, 0, 0), (8, 16, 3, 0, 0), (9, 18, 3, 0, 0), (10, 20, 3, 0, 0)]),
    (28, &[(8, 16, 3, 0, 0), (9, 18, 3, 0, 0), (10, 20, 3, 0, 0), (11, 22, 3, 0, 0)]),
    (24, &[(9, 18, 3, 0, 0), (10, 20, 3, 0, 0), (11, 22, 3, 0, 0), (12, 28, 3, 0, 0)]),
    (26, &[(11, 22, 3, 0, 0), (12, 28, 3, 0, 0), (13, 24, 3, 0, 0)]),
    (0, &[]),
    (6, &[(0, 0, 3, 0, 0)]),
