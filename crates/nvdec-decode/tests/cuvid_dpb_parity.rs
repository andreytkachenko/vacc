...
//!
//! This reads `assets/bframe_test.h264`, parses it with `vk-video-parser`, drives
...
// Auto-generated from NVIDIA cuvidParser dump of assets/bframe_test.h264.
...
const CUIDATA: &[(i32, &[Ref])] = &[
    ...
    (10, &[(0, 0, 3, 0, 0), (1, 6, 3, 0, 0), (2, 2, 3, 0, 0)]),
    (8, &[(1, 6, 3, 0, 0), (2, 2, 3, 0, 0), (3, 10, 3, 0, 0)]),
    (16, &[(1, 6, 3, 0, 0), (2, 2, 3, 0, 0), (3, 10, 3, 0, 0)]),
    (12, &[(1, 6, 3, 0, 0), (2, 2, 3, 0, 0), (3, 10, 3, 0, 0), (4, 16, 3, 0, 0)]),
    (14, &[(3, 10, 3, 0, 0), (4, 16, 3, 0, 0), (5, 12, 3, 0, 0)]),
    (22, &[(3, 10, 3, 0, 0), (4, 16, 3, 0, 0), (5, 12, 3, 0, 0)]),
    (18, &[(3, 10, 3, 0, 0), (4, 16, 3, 0, 0), (5, 12, 3, 0, 0), (6, 22, 3, 0, 0)]),
    (20, &[(4, 16, 3, 0, 0), (6, 22, 3, 0, 0), (7, 18, 3, 0, 0)]),
    (28, &[(4, 16, 3, 0, 0), (6, 22, 3, 0, 0), (7, 18, 3, 0, 0)]),
    (24, &[(4, 16, 3, 0, 0), (6, 22, 3, 0, 0), (7, 18, 3, 0, 0), (8, 28, 3, 0, 0)]),
    (26, &[(6, 22, 3, 0, 0), (8, 28, 3, 0, 0), (9, 24, 3, 0, 0)]),
    (0, &[]),
    (6, &[(0, 0, 3, 0, 0)]),
    (2, &[(0, 0, 3, 0, 0), (1, 6, 3, 0, 0)]),
    (4, &[(0, 0, 3, 0, 0), (1, 6, 3, 0, 0), (2, 2, 3, 0, 0)]),
    (12, &[(0, 0, 3, 0, 0), (1, 6, 3, 0, 0), (2, 2, 3, 0, 0)]),
    (8, &[(0, 0, 3, 0, 0), (1, 6, 3, 0, 0), (2, 2, 3, 0, 0), (3, 12, 3, 0, 0)]),
    (10, &[(1, 6, 3, 0, 0), (3, 12, 3, 0, 0), (4, 8, 3, 0, 0)]),
    (18, &[(1, 6, 3, 0, 0), (3, 12, 3, 0, 0), (4, 8, 3, 0, 0)]),
    (14, &[(1, 6, 3, 0, 0), (3, 12, 3, 0, 0), (4, 8, 3, 0, 0), (5, 18, 3, 0, 0)]),
    (16, &[(3, 12, 3, 0, 0), (5, 18, 3, 0, 0), (6, 14, 3, 0, 0)]),
    (20, &[(3, 12, 3, 0, 0), (5, 18, 3, 0, 0), (6, 14, 3, 0, 0)]),
    (26, &[(3, 12, 3, 0, 0), (5, 18, 3, 0, 0), (6, 14, 3, 0, 0), (7, 20, 3, 0, 0)]),
    (22, &[(5, 18, 3, 0, 0), (6, 14, 3, 0, 0), (7, 20, 3, 0, 0), (8, 26, 3, 0, 0)]),
    (24, &[(7, 20, 3, 0, 0), (8, 26, 3, 0, 0), (9, 22, 3, 0, 0)]),
    (28, &[(7, 20, 3, 0, 0), (8, 26, 3, 0, 0), (9, 22, 3, 0, 0)]),
    (0, &[]),
    (6, &[(0, 0, 3, 0, 0)]),
    (2, &[(0, 0, 3, 0, 0), (1, 6, 3, 0, 0)]),
    (4, &[(0, 0, 3, 0, 0), (1, 6, 3, 0, 0), (2, 2, 3, 0, 0)]),
    ...
    (20, &[(3, 12, 3, 0, 0), (5, 18, 3, 0, 0), (6, 14, 3, 0, 0), (7, 24, 3, 0, 0)]),
        ...
        match parser.parse(&packet) {
            Ok(ParseResult::ParameterSet { sps: sps_box, .. }) => {
                ...
                if dpb.is_none() {
                    if let Some(sb) = sps_box {
                        if let Some(sps) = sb.downcast_ref::<vk_video_core::picture::H264Sps>() {
            ...
            Ok(ParseResult::Slice { slices, .. }) => {
                ...
                let slh = match &slices[0].slice_header {
                    Some(vk_video_parser::SliceHeader::H264(h)) => h.clone(),
                    _ => break,
                };
                let dpb = dpb.as_mut().expect("DPB not initialized before first slice");
