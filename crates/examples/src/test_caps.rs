fn main() {
    ...
    if caps.nOutputFormatMask & (1 << 0) != 0 { println!("  Unknown (0)"); }
    if caps.nOutputFormatMask & (1 << 1) != 0 { println!("  NV12 (1)"); }
    if caps.nOutputFormatMask & (1 << 2) != 0 { println!("  P016 (2)"); }
    if caps.nOutputFormatMask & (1 << 3) != 0 { println!("  P016_BIG (3)"); }
    if caps.nOutputFormatMask & (1 << 4) != 0 { println!("  YUV444 (4)"); }
    if caps.nOutputFormatMask & (1 << 5) != 0 { println!("  YUV444_8Bit (5)"); }
    if caps.nOutputFormatMask & (1 << 6) != 0 { println!("  YUV420 (6)"); }
}
