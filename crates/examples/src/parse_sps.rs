...
fn main() {
    ...
    println!(
        ...
        chroma_name(sps.chroma_format_idc)
    );
    println!(
    ...
    println!(
        "\nbit_depth_luma_minus8          = {} (bit depth luma = {})",
        sps.bit_depth_luma_minus8, bit_depth_luma
    );
    println!(
        "bit_depth_chroma_minus8        = {} (bit depth chroma = {})",
        sps.bit_depth_chroma_minus8, bit_depth_chroma
    );
