...
mod tests {
    ...
    // ------------------------------------------------------------------
    // Golden header values for the bundled samples. Verified against
    // FFmpeg's VAAPI pic params and an independent bit-level reference
    // parser (first_partition_size + frame_header_length, 30 frames each).
    // ------------------------------------------------------------------
