...
pub struct DetectedVideoFormat {
    /// Codec type.
    pub codec: vacc_core::codec::VideoCodec,
    /// Chroma subsampling.
    pub chroma_subsampling: vacc_core::format::ChromaSubsampling,
    /// Luma bit depth.
    pub luma_bit_depth: vacc_core::format::ComponentBitDepth,
    /// Chroma bit depth.
    pub chroma_bit_depth: vacc_core::format::ComponentBitDepth,
    /// Coded width.
    pub coded_width: u32,
    /// Coded height.
...
impl DetectedVideoFormat {
    ...
    pub fn new(codec: vacc_core::codec::VideoCodec) -> Self {
        Self {
            codec,
            chroma_subsampling: vacc_core::format::ChromaSubsampling::_420,
            luma_bit_depth: vacc_core::format::ComponentBitDepth::Bit8,
            chroma_bit_depth: vacc_core::format::ComponentBitDepth::Bit8,
            coded_width: 0,
            coded_height: 0,
...
pub enum ParseResult {
    ...
    ParameterSet {
        ...
        vps: Option<vacc_core::picture::BoxedPictureParametersSet>,
