...
pub struct AccessUnit {
    ...
    pub h264_slice: Option<vacc_parser::h264::SliceHeader>,
...
// path compiling.
pub use vacc_parser::h264_dpb::H264MmcoCommand;

/// Enum to hold either H.264 or H.265 SPS.
#[derive(Debug, Clone)]
pub enum H264OrH265Sps {
    H264(vacc_core::picture::H264Sps),
    H265(vacc_core::picture::H265Sps),
}

/// Enum to hold either H.264 or H.265 PPS.
#[derive(Debug, Clone)]
pub enum H264OrH265Pps {
    H264(vacc_core::picture::H264Pps),
    H265(vacc_core::picture::H265Pps),
}

/// Enum to hold H.265 VPS.
#[derive(Debug, Clone)]
pub enum H265VpsOpt {
    H265(vacc_core::picture::H265Vps),
}
...
pub fn extract_all_access_units(
    ...
    let mut current_h264_slice: Option<vacc_parser::h264::SliceHeader> = None;
    ...
    let mut h264_parser = vacc_parser::h264::H264Parser::new();
    let mut poc_calc = vacc_parser::h264_poc::PocCalculator::new();
