...
impl VideoPipeline {
    ...
    pub fn update_session_parameters(
        &mut self,
        sps_h264: Option<&vacc_core::picture::H264Sps>,
        pps_h264: Option<&vacc_core::picture::H264Pps>,
        vps_h265: Option<&vacc_core::picture::H265Vps>,
        sps_h265: Option<&vacc_core::picture::H265Sps>,
        pps_h265: Option<&vacc_core::picture::H265Pps>,
    ) -> VideoResult<()> {
