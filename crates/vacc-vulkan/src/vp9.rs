...
pub struct Vp9Decoder {
    ...
    frame_buffer_to_dpb_slot: [i32; vacc_core::picture::VP9_NUM_REF_FRAMES as usize],
...
impl Vp9Decoder {
    pub fn new(device: ash::Device, instance: ash::Instance) -> Self {
        Self {
            ...
            session_params: None,
            frame_count: 0,
            frame_buffer_to_dpb_slot: [-1; vacc_core::picture::VP9_NUM_REF_FRAMES as usize],
...
pub fn convert_vp9_picture_info(
    info: &vacc_core::picture::Vp9PictureInfo,
    color_config: &vacc_core::picture::Vp9ColorConfig,
    loop_filter: &vacc_core::picture::Vp9LoopFilter,
    segmentation: &vacc_core::picture::Vp9Segmentation,
    ...
    let std_color_config = StdVideoVP9ColorConfig {
        ...
        color_space: match color_config.color_space {
            vacc_core::picture::Vp9ColorSpace::Unknown => StdVideoVP9ColorSpace::Unknown,
            vacc_core::picture::Vp9ColorSpace::Bt601 => StdVideoVP9ColorSpace::Bt601,
            vacc_core::picture::Vp9ColorSpace::Bt709 => StdVideoVP9ColorSpace::Bt709,
            vacc_core::picture::Vp9ColorSpace::Smpte170 => StdVideoVP9ColorSpace::Smpte170,
            vacc_core::picture::Vp9ColorSpace::Smpte240 => StdVideoVP9ColorSpace::Smpte240,
            vacc_core::picture::Vp9ColorSpace::Bt2020 => StdVideoVP9ColorSpace::Bt2020,
            vacc_core::picture::Vp9ColorSpace::Reserved => StdVideoVP9ColorSpace::Reserved,
            vacc_core::picture::Vp9ColorSpace::Rgb => StdVideoVP9ColorSpace::Rgb,
        },
    };
    ...
    Vp9PictureInfoContainer {
        std_picture_info: StdVideoDecodeVP9PictureInfo {
            ...
            profile: match info.profile {
                vacc_core::picture::Vp9Profile::Profile0 => StdVideoVP9Profile::Profile0,
                vacc_core::picture::Vp9Profile::Profile1 => StdVideoVP9Profile::Profile1,
                vacc_core::picture::Vp9Profile::Profile2 => StdVideoVP9Profile::Profile2,
                vacc_core::picture::Vp9Profile::Profile3 => StdVideoVP9Profile::Profile3,
            },
            frame_type: match info.frame_type {
                vacc_core::picture::Vp9FrameType::Key => StdVideoVP9FrameType::Key,
                vacc_core::picture::Vp9FrameType::Inter => StdVideoVP9FrameType::NonKey,
            },
            ...
            interpolation_filter: match info.interpolation_filter {
                vacc_core::picture::Vp9InterpolationFilter::EightTapSmooth => {
                    StdVideoVP9InterpolationFilter::EightTapSmooth
                }
                vacc_core::picture::Vp9InterpolationFilter::EightTap => {
                    StdVideoVP9InterpolationFilter::EightTap
                }
                vacc_core::picture::Vp9InterpolationFilter::EightTapSharp => {
                    StdVideoVP9InterpolationFilter::EightTapSharp
                }
                vacc_core::picture::Vp9InterpolationFilter::Bilinear => {
                    StdVideoVP9InterpolationFilter::Bilinear
                }
                vacc_core::picture::Vp9InterpolationFilter::Switchable => {
